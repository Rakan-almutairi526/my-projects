...
public class Course {
    ...
    public String toString() {
        return "Course code:" + getCourseCode() + " Title:" + getCourseTitle() + " Course Description: "+ getCourseDescription() +" Instructor ID:" + getInstructorId() + " Credits:" + getCredits() + " Capacity:" + getCapacity() + " Schedule:" + getSchedule();
    }
